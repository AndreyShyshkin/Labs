...
int main()
{
  ...
  cin >> precision;
  cout << " Введіть значення для х (бажано вводити значенння між -2 та 2, бо "
          "тільки на цьому проміжку вона існує "
       << endl;
  cin >> x;
  ...
  else
  {
    ...
    do
    {
      ...
      {
        //{cos(x/2)^2 * cos(2*x)
        answer = TailorCos(x / 2, precision) * TailorCos(x / 2, precision) *
                 TailorCos(2 * x, precision);
      }
